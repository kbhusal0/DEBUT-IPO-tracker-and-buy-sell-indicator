...
st.caption(
    "Pick a recent IPO and compare it against others to see whether it's "
    "tracking more like a historical winner or a historical loser."
)
...
with col2:
    ...
    if chart_data:
        ...
        st.caption("X-axis = trading days since IPO. Y-axis = % change from offer price.")
    else:
