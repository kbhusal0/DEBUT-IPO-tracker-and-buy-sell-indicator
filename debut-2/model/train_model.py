...
def train():
    ...
    if df["label"].nunique() < 2:
        print("All usable training examples have the same outcome (all "
              "'outperformed' or all 'didn't') — logistic regression needs "
              "at least one example of each to learn from.")
        print("Add a few more historical IPOs with mixed outcomes to seed_data.py and try again.")
        return
